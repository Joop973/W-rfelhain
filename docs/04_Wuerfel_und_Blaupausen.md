...
*Stand: 2026-06-30. Update: §1.1 um Kristallisations-Mechanik (Übermut→Gemüt, Welle-1-Tor-Fix) ergänzt.*
...
- **Gemüt liegt am Würfel**, nicht an der Seite — Schreck sperrt die höchsten *freien* Seiten dieses Würfels (02 §6.2).
...
- **Effekt-Seiten-Werte (1c) `[PROVISORISCH]`:** reine Effekt-Seiten (Gift, Brand, Echo, Glanz, Fläche, Beruhigung, Prägung, Labung) tragen je Seite einen eigenen Wert — teils **0** (reiner Effekt), teils kleiner Schadenswert. Pro Blaupause/Gravur einzeln festgelegt, Sim eicht. Konsequenz: manche Effekt-Seiten zählen für Gleichklang/Vollmond/Schreck mit, andere nicht.
...
## 2. Eichwart — Start-Arsenal `[GESPERRT]`

Arsenal-Start **6 Würfel**, Handgröße **5** (03 §1).

| # | Name | Typ | Seiten (1–6) | Atem |
|---|---|---|---|---|
| 1 | Astschneide | Schaden | 1, 2, 3, 4, 5, 6 | 1 |
| 2 | Astschneide | Schaden | 1, 2, 3, 4, 5, 6 | 1 |
| 3 | Astschneide | Schaden | 1, 2, 3, 4, 5, 6 | 1 |
| 4 | Astschneide | Schaden | 1, 2, 3, 4, 5, 6 | 1 |
| 5 | Borkenschild | Rinde | 1, 1, 2, 2, 3, 3 | 1 |
| 6 | Borkenschild | Rinde | 1, 1, 2, 2, 3, 3 | 1 |
...
- 3 Atem, alle auf Schaden → ~16,5 roh, deckt Region-1-Anker ~15–17/Zug (03 §12). `[GESPERRT-konsistent]`
...
| **Beruhigungs-Gravur** | Beruhigungs-Seite | +2 Gemüt | — | — | 1 | 30 (1 Stufe) | nur Würfel mit Schreck > 0; 1 Trösten = +2 |
...
- **Echo-, Glanz-, Beruhigungs-, Bruchstellen-Gravur sind 1-Stufen-Seiten** (kein 3-Stufen-Pfad) — sie tragen Mechanik, nicht Skalierung.
...
| 15 | **Sanftholz** | Stütze | Ber,Ber,2,2,3,3 | Beruhigungs- + Block-Mix (Pflege-Stütze) | Häufig | Belohnung | `[PROVISORISCH]` |
| 16 | **Wildwuchs** | Schaden | 2,3,6,6,6,Riss | brachiale Hochwert-Spanne, Eigen-Riss-Risiko | Episch | Event (Fluch-nah) | `[PROVISORISCH]` |

*Legende der Effekt-Seiten: F=Fäule auflegen, B=Brand, M=Morsch, W=Welk, K=Kraft, E=Echo, G=Glanz, Fl=Fläche, Ber=Beruhigung, Riss=Eigen-Riss.*
...
- Alle `[PROVISORISCH]`-Verzauberwerte (§3.2): Aufschläge, Status-Stapel, Preise.
- **Doppelschlag** als Gleichklang-Enabler: Lawinen-Risiko mit Wucht + Gleichklang gegenchecken.
- Blaupausen-Seitenverteilungen (§4): Ø-Werte und Effekt-Seiten-Anteil gegen Region-1-Pacing eichen.
...
- Drei 1-Stufen-Effekt-Gravuren (Echo/Glanz/Bruchstelle): Preis-Sinn gegen 3-Stufen-Pfade.
- **Kristallisations-Wechselwirkung mit Trösten-Gravuren** (Beruhigungs-Gravur, Quell/Labung): prüfen, ob ausreichend Trösten-Zugang in Region 1 verfügbar ist, um kristallisierten Schreck abzubauen, bevor die Spirale kippt (s. Welle-1-Tor-Befund, Nebenbefund zur Nichtlinearität).
