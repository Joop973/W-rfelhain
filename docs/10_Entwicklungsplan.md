...
- [ ] **E6 [C] Restposten**: Reifegrad-1/2-Nachschärfung (RG 2 misst 68,2 % > RG 0 — frühe Stufen sollen fühlbar sein, Bänder unten/oben halten) · Doppelschlag/Bruchstelle-Gravuren verdrahten · Fluch-System + die 3 wartenden Events (Moderpfütze, Schrein der raschen Gaben, Trockene Quelle) · `knoten.aktuell`-Puls-Frame (2-Frame-Animation) · UI-Chrome-Strings in `ui/main.js` auf Text-Keys umziehen (D7-Merkposten)
